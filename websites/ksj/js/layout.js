...
// 셀렉트박스
const selector = document.querySelector(".sub_sel");
const selector_wrap = document.querySelector(".select_wrap");
const selector_span = selector_wrap.querySelector("span");

selector.addEventListener("change", () => {
  let showText = selector.options[selector.selectedIndex].text;
  selector_span.textContent = showText;
